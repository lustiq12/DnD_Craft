...
public record Classability1Message(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<Classability1Message> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(DndCraftMod.MODID, "key_classability_1"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DndCraftMod.addNetworkMessage(Classability1Message.TYPE, Classability1Message.STREAM_CODEC, Classability1Message::handleData);
	}
}
