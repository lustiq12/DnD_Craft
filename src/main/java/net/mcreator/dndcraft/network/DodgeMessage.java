...
public record DodgeMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<DodgeMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(DndCraftMod.MODID, "key_dodge"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DndCraftMod.addNetworkMessage(DodgeMessage.TYPE, DodgeMessage.STREAM_CODEC, DodgeMessage::handleData);
	}
}
