...
public class PassiveabilitysProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		double sy = 0;
		double sz = 0;
		if (9 < entity.getData(DndCraftModVariables.PLAYER_VARIABLES).PlayerLevel) {
			if ((entity.getData(DndCraftModVariables.PLAYER_VARIABLES).Class_Variable).equals("Barbarian")) {
				...
				if (1 > entity.getData(DndCraftModVariables.PLAYER_VARIABLES).cooldown) {
					if (1 < entity.getData(DndCraftModVariables.PLAYER_VARIABLES).Ki) {
			...
			} else if ((entity.getData(DndCraftModVariables.PLAYER_VARIABLES).Class_Variable).equals("Fighter")) {
				if (entity instanceof Player _player) {
					_player.getAbilities().mayBuild = true;
					_player.onUpdateAbilities();
				}
		...
		if (19 < entity.getData(DndCraftModVariables.PLAYER_VARIABLES).PlayerLevel) {
			if ((entity.getData(DndCraftModVariables.PLAYER_VARIABLES).Class_Variable).equals("Barbarian")) {
				{
					Entity _ent = entity;
