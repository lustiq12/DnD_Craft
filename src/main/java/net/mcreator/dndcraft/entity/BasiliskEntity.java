...
import net.mcreator.dndcraft.procedures.BasiliskEntityIsHurtProcedure;
...
public class BasiliskEntity extends Monster implements GeoEntity {
	...
	public BasiliskEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DndCraftModEntities.BASILISK.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "basilisktexture");
	}
	...
	public static void init() {
		SpawnPlacements.register(DndCraftModEntities.BASILISK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
