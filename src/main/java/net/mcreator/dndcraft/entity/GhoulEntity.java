...
public class GhoulEntity extends Monster implements GeoEntity {
	...
	public GhoulEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DndCraftModEntities.GHOUL.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(DndCraftModEntities.GHOUL.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
