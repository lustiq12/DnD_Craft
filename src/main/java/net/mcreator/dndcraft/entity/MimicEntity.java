...
import net.mcreator.dndcraft.procedures.MimicEntityDiesProcedure;
...
public class MimicEntity extends Monster implements GeoEntity {
	...
	public MimicEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DndCraftModEntities.MIMIC.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "mimictexture");
	}
	...
	public static void init() {
		SpawnPlacements.register(DndCraftModEntities.MIMIC.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
