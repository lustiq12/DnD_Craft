...
import net.mcreator.dndcraft.procedures.GoblinOnInitialEntitySpawnProcedure;
...
public class GoblinEntity extends Monster implements GeoEntity {
	...
	public GoblinEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DndCraftModEntities.GOBLIN.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "rustygoblin");
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		GoblinOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(DndCraftModEntities.GOBLIN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
