...
public class BowblinEntity extends Monster implements RangedAttackMob, GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BowblinEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BowblinEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BowblinEntity.class, EntityDataSerializers.STRING);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "bow2");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new BowblinEntity.RangedAttackGoal(this, 1.25, 30, 15f) {
			@Override
	...
	public class RangedAttackGoal extends Goal {
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((BowblinEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	public void baseTick() {
		super.baseTick();
		IronGoblinOnEntityTickUpdateProcedure.execute(this);
	...
	public static void init() {
		SpawnPlacements.register(DndCraftModEntities.BOWBLIN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BowblinEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
