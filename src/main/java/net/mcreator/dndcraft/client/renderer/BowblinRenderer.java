...
import net.mcreator.dndcraft.entity.model.BowblinModel;
...
public class BowblinRenderer extends GeoEntityRenderer<BowblinEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, BowblinEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
