...
import net.mcreator.dndcraft.entity.model.MimicModel;
...
public class MimicRenderer extends GeoEntityRenderer<MimicEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, MimicEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
