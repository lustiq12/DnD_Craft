...
public class GoblinChiefRenderer extends GeoEntityRenderer<GoblinChiefEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, GoblinChiefEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
