...
public class InvisibleStalkerRenderer extends GeoEntityRenderer<InvisibleStalkerEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, InvisibleStalkerEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
