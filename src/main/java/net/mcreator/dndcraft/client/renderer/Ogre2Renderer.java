...
public class Ogre2Renderer extends GeoEntityRenderer<Ogre2Entity> {
	...
	@Override
	public void preRender(PoseStack poseStack, Ogre2Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
