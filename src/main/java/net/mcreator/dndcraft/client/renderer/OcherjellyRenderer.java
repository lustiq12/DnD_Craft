...
public class OcherjellyRenderer extends GeoEntityRenderer<OcherjellyEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OcherjellyEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
