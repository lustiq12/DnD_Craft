...
public class GhoulRenderer extends GeoEntityRenderer<GhoulEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, GhoulEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
