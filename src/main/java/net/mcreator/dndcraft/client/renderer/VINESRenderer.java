...
public class VINESRenderer extends GeoEntityRenderer<VINESEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, VINESEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
