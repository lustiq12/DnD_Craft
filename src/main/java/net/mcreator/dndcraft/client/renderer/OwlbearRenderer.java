...
public class OwlbearRenderer extends GeoEntityRenderer<OwlbearEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OwlbearEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
