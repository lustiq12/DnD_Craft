...
import net.mcreator.dndcraft.entity.model.IronGoblinModel;
...
public class IronGoblinRenderer extends GeoEntityRenderer<IronGoblinEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, IronGoblinEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
