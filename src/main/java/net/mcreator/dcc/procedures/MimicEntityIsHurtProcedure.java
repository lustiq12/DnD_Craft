	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity sourceentity) {
		...
		if (Mth.nextInt(RandomSource.create(), 1, 15) == 15) {
			...
			DccMod.queueServerWork(10, () -> {
				if (sourceentity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(DccModMobEffects.SLIMY, 60, 2));
			});
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles((SimpleParticleType) (DccModParticleTypes.SLIMYPARTICLE.get()), x, y, z, 2500, 2, 2, 2, 0.1);
		}
	}
}
