package net.mcreator.dcc.world.features.treedecorators;
...
public class FeywildSwampLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<FeywildSwampLeaveDecorator> CODEC = MapCodec.unit(FeywildSwampLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("dcc:feywild_swamp_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public FeywildSwampLeaveDecorator() {
		super(0.25f);
	}
