...
public class FeywildSwampTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<FeywildSwampTrunkDecorator> CODEC = MapCodec.unit(FeywildSwampTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("dcc:feywild_swamp_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
