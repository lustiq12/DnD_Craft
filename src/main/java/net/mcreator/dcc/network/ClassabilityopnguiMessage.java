...
import net.mcreator.dcc.procedures.ClassguiProcedure;
...
public record ClassabilityopnguiMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<ClassabilityopnguiMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(DccMod.MODID, "key_classabilityopngui"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DccMod.addNetworkMessage(ClassabilityopnguiMessage.TYPE, ClassabilityopnguiMessage.STREAM_CODEC, ClassabilityopnguiMessage::handleData);
	}
}
