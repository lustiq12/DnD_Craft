...
import net.mcreator.dcc.procedures.DruidProcedure;
...
public record DruidGuiButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<DruidGuiButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(DccMod.MODID, "druid_gui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DccMod.addNetworkMessage(DruidGuiButtonMessage.TYPE, DruidGuiButtonMessage.STREAM_CODEC, DruidGuiButtonMessage::handleData);
	}
}