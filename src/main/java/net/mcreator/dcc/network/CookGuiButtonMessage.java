...
import net.mcreator.dcc.procedures.MonsterDelightlootProcedure;
import net.mcreator.dcc.procedures.DailyRationLootProcedure;
import net.mcreator.dcc.procedures.CookingVeteranLootProcedure;
...
public record CookGuiButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<CookGuiButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(DccMod.MODID, "cook_gui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DccMod.addNetworkMessage(CookGuiButtonMessage.TYPE, CookGuiButtonMessage.STREAM_CODEC, CookGuiButtonMessage::handleData);
	}
}