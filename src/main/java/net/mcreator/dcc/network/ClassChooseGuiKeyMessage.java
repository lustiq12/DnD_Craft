...
import net.mcreator.dcc.procedures.OpenClassGuiProcedure;
...
public record ClassChooseGuiKeyMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<ClassChooseGuiKeyMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(DccMod.MODID, "key_class_choose_gui_key"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DccMod.addNetworkMessage(ClassChooseGuiKeyMessage.TYPE, ClassChooseGuiKeyMessage.STREAM_CODEC, ClassChooseGuiKeyMessage::handleData);
	}
}
