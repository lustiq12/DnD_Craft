...
import net.mcreator.dcc.procedures.BarbarProcedure;
...
public record BarbarGuiButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<BarbarGuiButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(DccMod.MODID, "barbar_gui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DccMod.addNetworkMessage(BarbarGuiButtonMessage.TYPE, BarbarGuiButtonMessage.STREAM_CODEC, BarbarGuiButtonMessage::handleData);
	}
}