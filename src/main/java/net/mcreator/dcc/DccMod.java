...
import net.mcreator.dcc.init.DccModTabs;
import net.mcreator.dcc.init.DccModSounds;
...
@Mod("dcc")
public class DccMod {
	public static final Logger LOGGER = LogManager.getLogger(DccMod.class);
	public static final String MODID = "dcc";

	public DccMod(IEventBus modEventBus) {
		...
		DccModVariables.ATTACHMENT_TYPES.register(modEventBus);

		DccModMobEffects.REGISTRY.register(modEventBus);
		DccModMenus.REGISTRY.register(modEventBus);
		DccModParticleTypes.REGISTRY.register(modEventBus);
