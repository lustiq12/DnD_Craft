...
public class MagicscrollStrongInvisibilityItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.dcc.magicscroll_strong_invisibility.description_0"));
		list.add(Component.translatable("item.dcc.magicscroll_strong_invisibility.description_1"));
		list.add(Component.translatable("item.dcc.magicscroll_strong_invisibility.description_2"));
	}
