...
import net.mcreator.dcc.procedures.DaggerRightclickedOnBlockProcedure;
...
public class DaggerItem extends SwordItem {
	...
	public DaggerItem() {
		super(TOOL_TIER, new Item.Properties().attributes(SwordItem.createAttributes(TOOL_TIER, 3f, -2.1f)));
	}
