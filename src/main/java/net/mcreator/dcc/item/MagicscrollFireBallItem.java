...
public class MagicscrollFireBallItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.dcc.magicscroll_fire_ball.description_0"));
		list.add(Component.translatable("item.dcc.magicscroll_fire_ball.description_1"));
		list.add(Component.translatable("item.dcc.magicscroll_fire_ball.description_2"));
	}
