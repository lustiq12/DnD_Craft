...
import net.mcreator.dcc.client.renderer.SlotMachineEntityRenderer;
...
public class DccModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(DccModEntities.SLOT_MACHINE_ENTITY.get(), SlotMachineEntityRenderer::new);
	}
}