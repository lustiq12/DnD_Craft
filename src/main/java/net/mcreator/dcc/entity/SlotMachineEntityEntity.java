...
import net.mcreator.dcc.procedures.SlotMachineEntityRightClickedOnEntityProcedure;
import net.mcreator.dcc.init.DccModEntities;

public class SlotMachineEntityEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SlotMachineEntityEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public SlotMachineEntityEntity(EntityType<SlotMachineEntityEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	}
	...
	public void baseTick() {
		super.baseTick();
		SlotMachineEntityRightClickedOnEntityProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(DccModEntities.SLOT_MACHINE_ENTITY.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(SlotMachineEntityEntity.RemovalReason.KILLED);
