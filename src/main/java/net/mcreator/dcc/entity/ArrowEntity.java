...
public class ArrowEntity extends AbstractArrow implements ItemSupplier {
	...
	public static ArrowEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		ArrowEntity entityarrow = new ArrowEntity(DccModEntities.ARROW.get(), entity, world, null);
	...
	public static ArrowEntity shoot(LivingEntity entity, LivingEntity target) {
		ArrowEntity entityarrow = new ArrowEntity(DccModEntities.ARROW.get(), entity, entity.level(), null);
