...
import net.mcreator.dcc.procedures.GoblinOnInitialEntitySpawnProcedure;
...
public class GoblinEntity extends Monster implements GeoEntity {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "rustygoblin");
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(DccModEntities.GOBLIN.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
