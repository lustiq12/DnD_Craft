...
public class IronGoblinEntity extends Monster implements GeoEntity {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(IronGoblinEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(IronGoblinEntity.class, EntityDataSerializers.STRING);
