...
public class BullywugEntity extends PathfinderMob implements GeoEntity {
	...
	public BullywugEntity(EntityType<BullywugEntity> type, Level world) {
		super(type, world);
		xpReward = 4;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(DccModItems.SPEAR.get()));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(DccModEntities.BULLYWUG.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BullywugEntity.RemovalReason.KILLED);
