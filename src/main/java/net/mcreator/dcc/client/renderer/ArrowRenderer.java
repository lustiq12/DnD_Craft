...
public class ArrowRenderer extends EntityRenderer<ArrowEntity> {
	private static final ResourceLocation texture = ResourceLocation.parse("dcc:textures/entities/arrow.png");
	...
	@Override
	public void render(ArrowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
