...
import net.mcreator.dcc.entity.model.MimicSludgeModel;
...
public class MimicSludgeRenderer extends GeoEntityRenderer<MimicSludgeEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, MimicSludgeEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
