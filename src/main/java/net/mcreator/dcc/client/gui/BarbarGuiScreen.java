...
public class BarbarGuiScreen extends AbstractContainerScreen<BarbarGuiMenu> implements DccModScreens.ScreenAccessor {
	...
	public void init() {
		...
		button_choose = Button.builder(Component.translatable("gui.dcc.barbar_gui.button_choose"), e -> {
			int x = BarbarGuiScreen.this.x;
			int y = BarbarGuiScreen.this.y;
